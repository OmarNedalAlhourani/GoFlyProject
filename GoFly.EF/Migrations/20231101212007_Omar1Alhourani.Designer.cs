...
namespace GoFly.EF.Migrations
{
    ...
    [Migration("20231101212007_Omar1Alhourani")]
    partial class Omar1Alhourani
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoFly.BL.Models.CarPage.CarRent", b =>
                {
                    ...
                    b.Property<string>("PriseDay")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PriseMonth")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PriseWeek")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GoFly.BL.Models.HomePage.HotTour", b =>
                {
                    ...
                    b.Property<string>("HotTourPrise")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GoFly.BL.Models.HotelPage.HostelDestination", b =>
                {
                    ...
                    b.Property<string>("HostelDestinationPrise")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GoFly.BL.Models.Search.SearchFlight", b =>
                {
                    b.Property<int>("SearchFlightId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SearchFlightId"));
                    ...
                    b.Property<string>("SearchFlightFrom")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SearchFlightTo")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("SearchFlightId");

                    b.ToTable("SearchFlights");
                });

            modelBuilder.Entity("GoFly.BL.Models.Search.SearchHotel", b =>
                {
                    b.Property<int>("SearchHotelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SearchHotelId"));
                    ...
                    b.HasKey("SearchHotelId");

                    b.ToTable("SearchHotels");
                });

            modelBuilder.Entity("GoFly.BL.Models.Search.SearchPackage", b =>
                {
                    b.Property<int>("SearchPackageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SearchPackageId"));
                    ...
                    b.HasKey("SearchPackageId");

                    b.ToTable("SearchPackages");
                });

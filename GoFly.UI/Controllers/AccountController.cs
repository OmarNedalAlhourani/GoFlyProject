...
namespace GoFly.UI.Controllers
{
   ...
   // [Authorize]
        ...
        public IBaseRepository<Message> MessageRepository;
            public AccountController(UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, RoleManager<IdentityRole> roleManager,AppDbContext db,IBaseRepository<Message> _MessageRepository)
            {
          ...
          //  [AllowAnonymous]
           ...
           // [AllowAnonymous]
            ...
            public async Task<IActionResult> Login( LoginViewModel model,EditRoleViewModel Role)
            {
                if (!ModelState.IsValid)
                {

                    var result = await _signInManager.PasswordSignInAsync(model.Email!, model.Password!, model.RememberMe, false);
                    var res = await _roleManager.RoleExistsAsync("Adminstator");
